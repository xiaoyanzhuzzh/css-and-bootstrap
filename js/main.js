...
function  fullInTopics(){
  ...
  var value1_1_1 = document.getElementById('gap1').value;
  if(value1_1_1 == fullInSubject1.answer[0]){
    fullInSubject1.scores += fullInSubject1.scorePerSubject;
  }

  var value1_2 = [];
  value1_2.push(document.getElementById('gap2_1').value);
  value1_2.push(document.getElementById('gap2_2').value);
  value1_2.push(document.getElementById('gap2_3').value);
...
function shortAnswerTopics(){
  var shortAnswerSubject = new Subject(shortAnswerSubject,
    ...
    1,20);
  var value5 = document.getElementById("short5").value;
